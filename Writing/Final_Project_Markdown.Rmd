...
#3.4.3. Creating the final data set

To create the final dataset and in order to be able to create a Shinny App, geographical data from California counties was joined with human cases and weather data.
